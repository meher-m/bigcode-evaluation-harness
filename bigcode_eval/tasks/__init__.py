...
def get_task(task_name, args=None):
    try:
        ...
        kwargs["humaneval_one_shot"] = args.humaneval_one_shot
        kwargs["humaneval_prompt_quality"] = args.humaneval_prompt_quality
        kwargs["humaneval_add_context"] = args.humaneval_add_context
